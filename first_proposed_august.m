...
hazy_img= im2double(imread("/Users/vijaymadaan/Downloads/paper1 2/a14.jpg"));

%% Step 2: DCP Dehazing
mmle_img = dehaze_fast(hazy_img, 0.95, 15);
figure;imshow(mmle_img);
imwrite(mmle_img, 'DCP_5.png');
...
imwrite(enhanced_baselayer, 'BaseLayer_MCF_5.png');
...
imwrite(f_final, 'final_image_5.png');
