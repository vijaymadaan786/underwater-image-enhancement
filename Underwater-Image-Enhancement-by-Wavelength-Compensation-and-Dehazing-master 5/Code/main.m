...
close all
clear all
im = im2double(imread('/Users/vijaymadaan/MATLAB-Drive/Hazy Images with Ref/a18.jpg'));
imshow(im);
...
imwrite(enhancedImage, '/Users/vijaymadaan/Downloads/Results/Wavelength_compensation/a18_Wavelength_compensation.jpg');
